...
// ─────────────────────────────────────────────────────────────────────────────
// Vergleichs-Person aus taetigkeiten-buchen-korrigieren-test.txt
// (gespiegelte Backend-Antwort, damit das Korrigieren-Detail-Layout
//  1:1 mit der alten Anwendung verglichen werden kann)
// ─────────────────────────────────────────────────────────────────────────────
export const MOCK_PERSON_1500000000579: ApiPerson = {
  id: '1500000000579',
  version: 1,
  deleted: false,
  state: ApiState.READ,
  ...
  vorname: 'Peter Franz',
  nachname: 'Thiem',
  portalUser: 'thiem01@rrr.at',
  email: 'peter-1m@xx.at',
  aktiv: true,
  rolle: ApiRolle.ADMIN_PROJECT_OFFICE,
  bucher: 'GEPLANTER_BUCHER' as any,
  recht: [
    'STEMPELN',
    'REMOTE_USER',
    'BEREITSCHAFT',
  ...
  mitarbeiterart: ApiMitarbeiterart.EXTERN,
  geprueft: true,
  stundenkontingentJaehrlich: '1500',
  stundenkontingentJaehrlichVertrag: '1300',
  funktion: ['TEAMLEITER', 'ABTEILUNGSLEITER'] as any,
  vertrag: [],
  stundenGeplantDiesesJahr: 162,
  stundenGebuchtDiesesJahr: '10.50',
};
MOCK_PERSONEN.push(MOCK_PERSON_1500000000579);
...
export const MOCK_VERTRAEGE: ApiVertrag[] = [
  {
    ...
    lkKennung: true,
    lkBasisstundensatz: '1000.00',
    volumenLeistungspunkte: '200000.00',
    lkDetails: [
      { id: 'lkd-v1-1', version: 1, deleted: false, state: ApiState.READ,
        lkKategorie: 'Eins', lkBezeichnung: 'Eins', lkFaktor: '1.000000' },
      { id: 'lkd-v1-2', version: 1, deleted: false, state: ApiState.READ,
        lkKategorie: 'Zwei', lkBezeichnung: 'Zwei', lkFaktor: '2.000000' },
    ],
    vertragPosition: [
      {
  ...
  },
  {
    ...
    lkKennung: true,
    lkBasisstundensatz: '195.00',
    volumenLeistungspunkte: '18000.00',
    lkDetails: [
      { id: 'lkd-v2-1', version: 1, deleted: false, state: ApiState.READ,
        lkKategorie: 'Standard', lkBezeichnung: 'Standard', lkFaktor: '1.000000' },
      { id: 'lkd-v2-2', version: 1, deleted: false, state: ApiState.READ,
        lkKategorie: 'Premium', lkBezeichnung: 'Premium', lkFaktor: '1.500000' },
    ],
    vertragPosition: [
      {
  ...
  },
  {
    ...
    lkKennung: true,
    lkBasisstundensatz: '130.00',
    volumenLeistungspunkte: '5500.00',
    lkDetails: [
      { id: 'lkd-v3-1', version: 1, deleted: false, state: ApiState.READ,
        lkKategorie: 'Basis', lkBezeichnung: 'Basis', lkFaktor: '1.000000' },
      { id: 'lkd-v3-2', version: 1, deleted: false, state: ApiState.READ,
        lkKategorie: 'Senior', lkBezeichnung: 'Senior', lkFaktor: '1.250000' },
    ],
    vertragPosition: [
      {
...
// ─────────────────────────────────────────────────────────────────────────────
// Vergleichsdaten Person 1500000000579 (Peter Franz Thiem)
// Quelle: taetigkeiten-buchen-korrigieren-test.txt
// Wird vom Mock-Interceptor nur für diese Person-ID ausgeliefert.
// ─────────────────────────────────────────────────────────────────────────────
export const MOCK_PERSON_1500000000579_PRODUKTE: ApiProdukt[] = [
  {
    id: '2600000000196',
    version: 5,
    deleted: false,
    state: ApiState.READ,
    produktname: 'Tätigkeitsbericht IV/2',
    start: '2018-02-06T00:00:00.000',
    ende: '9999-12-31T00:00:00.000',
    aktiv: true,
    kurzName: 'GET-IT',
    auftraggeber: 'Fandler Mike',
    auftraggeberOrganisation: 'IV/2',
    produktTyp: ApiProduktTyp.ANWENDUNG,
    produktPosition: [
      {
        id: '2600000000439',
        ...
        deleted: false,
        state: ApiState.READ,
        produktPositionname: 'Betrieb',
        start: '2006-02-01T00:00:00.000',
        ende: '2999-12-31T00:00:00.000',
        aktiv: true,
        auftraggeber: 'IV/2',
        auftraggeberOrganisation: 'IV/2/a',
        produktPositionTyp: 'WARTUNG' as any,
        buchungsfreigabe: true,
        produktPositionBuchungspunkt: [
          {
            ...
            taetigkeitsbuchung: [
              {
                ...
                state: ApiState.READ,
                minutenDauer: 5,
                taetigkeit: 'FIRST_LEVEL_SUPPORT' as any,
                jiraTicket: 'PGET-22',
                anmerkung: 'XXX',
                datum: '2026-04-02T00:00:00.000',
                zeitTyp: ApiZeitTyp.REMOTEZEIT,
                tagesabschluss: true,
                tagesabschlussAufgehoben: false,
                monatsabschluss: false,
                buchungsart: 'KORREKTUR' as any,
                freigabepositionVorhanden: false,
                stempelzeit: {
                  id: '506200000000428',
                  version: 1,
                  deleted: false,
                  state: ApiState.READ,
                  login: '2026-04-02T23:16:00.000',
                  logoff: '2026-04-02T23:21:00.000',
                  zeitTyp: ApiZeitTyp.REMOTEZEIT,
                  poKorrektur: false,
                  marker: [],
  ...
  } as any,
  {
    ...
    deleted: false,
    state: ApiState.READ,
    produktname: 'Competence Center for Quality Assurance',
    start: '2024-01-01T00:00:00.000',
    ende: '9999-12-31T00:00:00.000',
    aktiv: true,
    kurzName: 'CCQA',
    auftraggeber: 'Alfred SOARE',
    auftraggeberOrganisation: 'IV/DDS/!!',
    produktTyp: 'ADMINISTRATION' as any,
    produktPosition: [
      {
        id: '321700000000025',
        version: 4,
        deleted: false,
        state: ApiState.READ,
        produktPositionname: 'CCQA',
        start: '2024-01-01T00:00:00.000',
        ende: '9999-12-31T00:00:00.000',
        aktiv: true,
        auftraggeber: 'Alfred SOARE',
        auftraggeberOrganisation: 'IV/DDS/11',
        produktPositionTyp: 'WARTUNG' as any,
        buchungsfreigabe: true,
        produktPositionBuchungspunkt: [
          {
            ...
            taetigkeitsbuchung: [
              {
                ...
                stempelzeit: {
                  ...
                  deleted: false,
                  state: ApiState.READ,
                  login: '2026-05-04T01:00:00.000',
                  logoff: '2026-05-04T01:06:00.000',
                  zeitTyp: ApiZeitTyp.REMOTEZEIT,
                  poKorrektur: false,
                  marker: [],
                  eintragungsart: ApiStempelzeitEintragungsart.NORMAL,
            ...
            taetigkeitsbuchung: [
              {
                ...
                state: ApiState.READ,
                minutenDauer: 40,
                taetigkeit: 'SECOND_LEVEL_SUPPORT' as any,
                anmerkung: 'Test',
                datum: '2026-05-04T00:00:00.000',
                zeitTyp: ApiZeitTyp.REMOTEZEIT,
                tagesabschluss: true,
                ...
                stempelzeit: {
                  ...
                  deleted: false,
                  state: ApiState.READ,
                  login: '2026-05-04T02:05:00.000',
                  logoff: '2026-05-04T02:45:00.000',
                  zeitTyp: ApiZeitTyp.REMOTEZEIT,
                  poKorrektur: false,
                  marker: [],
                  eintragungsart: ApiStempelzeitEintragungsart.NORMAL,
...
export const MOCK_PERSON_1500000000579_STEMPELZEITEN: ApiStempelzeit[] = [
  {
    id: '505900000000438',
    version: 1,
    deleted: false,
    state: ApiState.READ,
    login: '2026-04-02T00:00:00.000',
    logoff: '2026-04-02T01:00:00.000',
    zeitTyp: 'BEREITSCHAFT' as any,
    poKorrektur: false,
    marker: [],
    eintragungsart: ApiStempelzeitEintragungsart.NORMAL,
  },
  {
    ...
    state: ApiState.READ,
    login: '2026-04-02T00:00:00.000',
    logoff: '2026-04-02T22:00:00.000',
    anmerkung: '',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: true,
    marker: [],
  ...
  },
  {
    ...
    deleted: false,
    state: ApiState.READ,
    login: '2026-04-02T23:01:00.000',
    logoff: '2026-04-02T23:11:00.000',
    anmerkung: 'sss',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: false,
    marker: [],
  ...
  },
  {
    ...
    deleted: false,
    state: ApiState.READ,
    login: '2026-04-13T00:00:00.000',
    logoff: '2026-04-13T09:00:00.000',
    anmerkung: 'TES',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: true,
    marker: [],
  ...
  },
  {
    ...
    deleted: false,
    state: ApiState.READ,
    loginSystem: '2026-04-24T08:19:57.535',
    logoffSystem: '2026-04-24T08:20:59.246',
    login: '2026-04-24T08:19:00.000',
    logoff: '2026-04-24T08:20:00.000',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: false,
    marker: [
      'TEMP_ABWESENHEIT',
      'ONLINE_STEMPELN_ABMELDUNG',
      'HOMEOFFICE_STEMPELN_ANMELDUNG',
    ] as any,
    eintragungsart: ApiStempelzeitEintragungsart.NORMAL,
  },
  {
    ...
    deleted: false,
    state: ApiState.READ,
    loginSystem: '2026-04-24T08:22:18.831',
    logoffSystem: '2026-04-24T08:25:08.427',
    login: '2026-04-24T08:22:00.000',
    logoff: '2026-04-24T08:25:00.000',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: false,
    marker: ['ONLINE_STEMPELN_ANMELDUNG', 'ONLINE_STEMPELN_ABMELDUNG'] as any,
    eintragungsart: ApiStempelzeitEintragungsart.NORMAL,
  },
  {
    id: '498300000000695',
    ...
    deleted: false,
    state: ApiState.READ,
    loginSystem: '2026-04-24T08:25:30.762',
    logoffSystem: '2026-04-24T08:36:15.243',
    login: '2026-04-24T08:25:00.000',
    logoff: '2026-04-24T08:36:00.000',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: false,
    marker: [
      'TEMP_ABWESENHEIT',
      'ONLINE_STEMPELN_ANMELDUNG',
      'ONLINE_STEMPELN_ABMELDUNG',
    ] as any,
    eintragungsart: ApiStempelzeitEintragungsart.NORMAL,
  },
  {
    ...
    deleted: false,
    state: ApiState.READ,
    loginSystem: '2026-04-24T09:40:50.478',
    logoffSystem: '2026-04-29T07:50:51.249',
    login: '2026-04-24T09:40:00.000',
    logoff: '2026-04-24T09:41:00.000',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: false,
    marker: ['ONLINE_STEMPELN_ANMELDUNG', 'ONLINE_STEMPELN_ABMELDUNG'] as any,
    eintragungsart: ApiStempelzeitEintragungsart.NORMAL,
  },
  {
    ...
    deleted: false,
    state: ApiState.READ,
    loginSystem: '2026-04-29T07:55:05.811',
    logoffSystem: '2026-04-29T07:57:16.409',
    login: '2026-04-29T07:55:00.000',
    logoff: '2026-04-29T07:57:00.000',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: false,
    marker: [
      'TEMP_ABWESENHEIT',
  ...
  },
  {
    ...
    deleted: false,
    state: ApiState.READ,
    loginSystem: '2026-04-29T07:58:35.136',
    logoffSystem: '2026-04-29T08:01:51.795',
    login: '2026-04-29T07:58:00.000',
    logoff: '2026-04-29T08:01:00.000',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: false,
    marker: ['ONLINE_STEMPELN_ANMELDUNG', 'ONLINE_STEMPELN_ABMELDUNG'] as any,
    eintragungsart: ApiStempelzeitEintragungsart.NORMAL,
  ...
  },
  {
    ...
    deleted: false,
    state: ApiState.READ,
    login: '2026-05-04T07:55:00.000',
    logoff: '2026-05-04T08:00:00.000',
    anmerkung: '',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: false,
    marker: [],
  ...
  },
  {
    ...
    deleted: false,
    state: ApiState.READ,
    login: '2026-05-04T08:00:00.000',
    logoff: '2026-05-04T08:01:00.000',
    anmerkung: '',
    zeitTyp: ApiZeitTyp.ARBEITSZEIT,
    poKorrektur: false,
    marker: [],
...
export const MOCK_PERSON_1500000000579_ABSCHLUSS_INFO: any = {
  naechsterBuchbarerTag: '2026-02-08',
  naechsterTagesabschlussAufheben: '2024-01-16',
  letzterMonatsabschluss: '2026-01',
  letzterGlobalerMonatsabschluss: '2026-01',
  ersteBuchung: '2015-01-07',
};

export const MOCK_PERSON_1500000000579_PERSONENVERMERKE: ApiPersonenvermerk[] = [];
