...
@Component({
  ...
  styleUrl: './zivildiener-detail.component.scss'
})
export class ZivildienerDetailComponent {
  ...
  goBackToList() {
    this.router.navigate(['/zivildiener']);
  }
  ...
  saveStempelzeit() {
    console.log('SAVE STEMPELZEIT-tempelzeitForm ', this.stempelzeitForm);
    ...
    console.log('SAVE STEMPELZEIT-tempelzeitForm-2 ', this.stempelzeitForm);
    console.log('Full form value:', this.stempelzeitForm.getRawValue());

    if (this.stempelzeitForm.valid && this.personId) {
      const formValue = this.stempelzeitForm.getRawValue();//.value;
